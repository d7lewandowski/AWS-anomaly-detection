...
value_0 = "No Special Event detect - no crowds"
value_1 = "Special Event detect - crowds"
...
def lambda_handler(event, context):
   ...
   for i in range(0,len(data)):
      ...
      outlier = 2.2 # this value is compute in notebook. Value above 2.2 appoint something abnormal like "Special event" if we assume more pedestrian outside mean "Special event"  
...
Response:
[
  "score: 1.1060338799 No Special Event detect - no crowds",
  "score: 0.906436714 No Special Event detect - no crowds",
  "score: 4.0291661586 Special Event detect - crowds",
  "score: 4.1417008367 Special Event detect - crowds"
]
"""